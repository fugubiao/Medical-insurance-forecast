...
def data_initialization(data, train_file, dev_file, test_file):
    data.build_alphabet(train_file) #'data/NER_DATA/Weibo/weiboNER.dev'
    data.build_alphabet(dev_file) #'data/NER_DATA/Weibo/weiboNER.test'
    data.build_alphabet(test_file) #'data/NER_DATA/Weibo/weiboNER.train'
    data.fix_alphabet()
    return data


def load_data_setting(save_file):
    with open(save_file, 'rb',encoding="utf-8") as fp:  #学生修改：encoding
        data = pickle.load(fp)
